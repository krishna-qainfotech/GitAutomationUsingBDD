...
//	}
	...
	public void i_enter_password_as(String arg1) throws Exception {
		System.out.println("Do not Share your password : "+arg1);
	}

	@Then("^I enter title as \"([^\"]*)\"$")
	public void i_enter_title_as(String arg1) throws Exception {
	System.out.println("Your desgination : "+arg1);
	}

	@Then("^press submit$")
	public void press_submit() throws Exception {
	}	
...
public void user_Enter_Valid_Credential(DataTable arg1) throws Exception {
	List<List<String>> data = arg1.raw();
	driver.findElement(By.id("login_field")).sendKeys(data.get(0).get(0));
...
@Then("^User Should Be on Git$")
public void user_Should_Be_on_Git() throws Exception {
	Boolean tre=driver.findElement(By.xpath("//*[text()='Read the guide']")).isDisplayed();
	if(tre==true) {
...
public void user_is_Signed_in() throws Exception {
	if(driver.getCurrentUrl()=="https://github.com/") {
...
public void user_Click_on_Sign_out() throws Exception {
	...
	driver.findElement(By.cssSelector("[alt=\"@krishna-qainfotech\"]")).click();
	driver.findElement(By.xpath("//*[@role=\"menuitem\" and contains(text(),'Sign out')]")).click();	
}

@Then("^User Should See Build For Developer msg$")
public void user_Should_See_Build_For_Developer_msg() throws Exception {
    // Write code here that turns the phrase above into concrete actions

	if(driver.findElement(By.xpath("//*[text()='Built for developers']")).isDisplayed()) {
